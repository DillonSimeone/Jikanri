...
var app = (function () {
    ...
    /* src/components/Layout.svelte generated by Svelte v3.19.2 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!default_slot) {
    				t = text("this page is currently empty.");
    			}

    			if (default_slot) default_slot.c();
    			attr_dev(div, "class", "grid-wrapper svelte-198fdyz");
    			add_location(div, file$1, 16, 4, 337);
    			attr_dev(main, "class", "layout-wrapper svelte-198fdyz");
    			add_location(main, file$1, 15, 0, 303);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/pages/Setup.svelte generated by Svelte v3.19.2 */

    function create_fragment$4(ctx) {
    	let current;
    	const layout = new Layout({ $$inline: true });
    ...
    function create_default_slot_1(ctx) {
    	let current;
    	const setup = new Setup({ $$inline: true });
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 7, 2, 162);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Link, Route, Setup, url });
